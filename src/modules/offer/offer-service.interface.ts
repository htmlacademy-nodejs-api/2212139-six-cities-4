...
export interface OfferServiceInterface {
  ...
  findPremiumOffers(count?: number): Promise<DocumentType<OfferEntity>[]>;
  findFavoriteOffers(count?: number): Promise<DocumentType<OfferEntity>[]>;
  setFavoriteStatusOffer(offerId: string, dto: UpdateOfferDto): Promise<DocumentType<OfferEntity> | null>;
